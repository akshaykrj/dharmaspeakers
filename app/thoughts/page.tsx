                  ...
                  {articles.map(({ title, speaker, source, url, year }) => (
                    <li key={url}>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex flex-col gap-1 h-full rounded-md border border-[#E6E4DF] bg-white px-4 py-3 hover:border-[#D4A441] transition group"
                      >
                        <p className="text-[14px] text-[#2B2B2B] group-hover:text-[#D4A441] transition leading-snug flex-1">{title}</p>
                        <p className="text-[12px] text-[#D4A441] mt-2">{speaker}</p>
